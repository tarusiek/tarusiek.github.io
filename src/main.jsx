...
const stackGroups = [
  ...
  ["Hardware", ["Inventor", "SolidWorks", "KiCad", "Arduino", "STM32", "ESP32"]],
];
...
const copy = {
  en: {
    ...
    hero: {
      ...
      text: "Independent developer and mechatronics creator. I build premium mobile apps, refined web platforms, and products that connect code with the real world.",
      primary: "View projects",
      secondary: "Send email",
    },
    stats: [
      ["20", "+", "Delivered projects"],
      ["6", "yrs", "Building products"],
      ["50", "k", "Page views"],
    ...
    labels: {
      ...
      stack: ["05", "Technologies", "tools.config"],
      process: ["06", "Process", "4 stages"],
      contact: ["07", "Contact", "open inbox"],
    },
    about: {
      role: "Developer / CAD Designer",
      status: "Available",
      headline: <>A developer with an <span>engineer's</span> mindset: methodical, curious, and focused on the details that make a difference.</>,
      points: [
        ["01", "Mechatronics: CAD, electronics, automation, and embedded systems.", "Education"],
        ["02", "Cross-platform mobile apps with a native feel and clean architecture.", "Apps"],
        ["03", "Advanced web apps and dashboards: fast, accessible, and stable.", "Web"],
        ["04", "Portfolios and sales pages that look premium and genuinely support sales.", "Design"],
        ["05", "I connect code, circuits, enclosures, conveyors, and real users.", "CAD"],
      ],
    },
    servicesHeading: ["What do I build?", "Four connected disciplines that give every project product thinking, visual quality, and technical truth."],
    services: [
      ["01", "Apps", "Mobile Apps", "I design iOS and Android apps with polished interfaces, smooth animations, and architecture ready for growth.", ["React Native", "SwiftUI", "Expo", "SQLite"], "phone"],
      ["02", "Web", "Web Platforms", "Company websites, booking systems, dashboards, and business builds that need speed, quality, and credibility.", ["React", "Next.js", "TypeScript", "Postgres"], "web"],
      ["03", "Identity", "Premium Sites", "Portfolios and sales pages with strong typography, intentional motion, and conversion-focused messaging.", ["Framer Motion", "UI Systems", "SEO", "Analytics"], "type"],
      ["04", "CAD", "CAD / Conveyors", "I have designed belt conveyors, mechanical assemblies, and structural elements, combining CAD precision with production practice.", ["Inventor", "SolidWorks", "Conveyors", "Documentation"], "hardware"],
    ],
    workHeading: ["Selected projects.", "02 shown / 20+ total"],
    featured: [
      ["Mobile App - iOS / Android", "Soon", "Roomsy", "Temporary card for a new mobile app. Roomsy is currently in preparation and will soon launch as a polished product for users who want to manage spaces, bookings, and everyday decisions faster.", ["React Native", "Animations", "Product", "Soon"], "mobile"],
      ["Website - Restaurant", "2020 - 2026", "Restaurant project", "A modern website for a restaurant: an elegant first screen, clear menu, fast contact, reservations, and the brand's atmosphere carried into the interface. Built for trust, aesthetics, and real guest inquiries.", ["React", "Responsive", "SEO", "Reservations"], "dashboard"],
    ],
    projects: [
      ["03", "CAD - Conveyors", "Belt conveyors", "Designs for internal transport systems, support structures, and mechanical elements prepared for production.", "2020 - 2026"],
      ["04", "Web - Restaurant", "Restaurant website", "A build focused on the venue's atmosphere, menu, reservations, and fast mobile contact.", "2020 - 2026"],
      ["05", "Mobile App", "OuthApp", "An upcoming mobile app. This is currently a temporary project card for a product that will be shown more broadly soon.", "Soon"],
      ["06", "Mechatronics - IoT", "Telemetry system", "An ESP32 sensor network connected with a readable dashboard and an app for monitoring data.", "2020 - 2026"],
    ],
    stackHeading: ["Proven tools, sharp results.", "I rely on stable tools, strong architecture, and refined interactions. Exotic tech only enters when the problem truly needs it."],
    processHeading: ["From idea to deployment.", "A lightweight process that delivers premium work to production without turning the project into a heavy ritual."],
    process: [
      ["01", "Idea", "Days 1-3", "We define the goal, constraints, success metrics, and the product's most important job.", ["Intro call", "Specification document", "Fixed quote"]],
      ["02", "Design", "Week 1-2", "We turn the direction into a refined interface with interaction notes and responsive states.", ["User journey", "Visual system", "Animation sketch"]],
      ["03", "Development", "Week 2-6", "Build in visible iterations: working demos, production code, and fast quality checks.", ["Daily progress", "Testing", "Optimization"]],
      ["04", "Deployment", "Release", "Deployment, analytics, publication, and the first month of post-launch support.", ["Automation", "Analytics", "30 days of support"]],
    ],
    contact: {
      label: "Delivery scope - 2020 - 2026",
      heading: <>Have a project in mind? <span>Let's build it.</span></>,
      emailSmall: "mail",
      send: "Send email",
      cv: "Download CV",
      meta: [["Response time", "Within 24 hours"], ["Availability", "2 project slots"], ["LinkedIn", "LinkedIn profile", linkedInProfileUrl]],
    },
    footer: ["2026 - Michał", "Have a great day!", "v3.1"],
    local: "Time",
  },
  pl: {
    brand: "MICHAŁ - DEV/PL",
    ...
    services: [
      ...
      ["04", "CAD", "CAD / Przenośniki", "Projektowałem przenośniki taśmowe, układy mechaniczne i elementy konstrukcyjne, łącząc dokładność CAD z praktyką produkcyjną.", ["Inventor", "SolidWorks", "Przenośniki", "Dokumentacja"], "hardware"],
    ],
    workHeading: ["Wybrane realizacje.", "02 pokazanych / 20+ łącznie"],
    featured: [
    ...
    projects: [
      ...
      ["05", "Aplikacja mobilna", "OuthApp", "Nadchodząca aplikacja mobilna. Aktualnie karta tymczasowa projektu, który niedługo zostanie pokazany szerzej.", "Wkrótce"],
